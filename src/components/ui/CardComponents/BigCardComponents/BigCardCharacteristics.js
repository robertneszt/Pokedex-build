        ...
        <div className=" h-full bg-white rounded-3xl flex-row justify-center xl:justify-start xl:flex ">
          <div className=" h-full w-36 xl:w-1/2 ">
            <div className=" h-1/2 flex flex-col justify-center p-0 xl:p-8 ">
              <p className="text-lg text-blueTheme text-center xl:text-2xl">
                Weight:
              </p>
              <p className="text-lg text-softGreenFontColor text-center xl:text-2xl">
                {weight}
              </p>
            </div>
          ...
          <div className=" h-full w-36 xl:w-1/2 p-0 xl:p-8 xl:pr-10 overflow-auto">
            <p className=" h-1/4 text-blueTheme text-lg text-center mb-0 xl:mb-1 xl:text-2xl">
              Abilities:
            </p>
            <div className="flex flex-col justify-center">
              {abilities.map((ability, index) => (
                <p
                  key={index}
                  className="text-lg text-softGreenFontColor xl:text-end text-center capitalize xl:text-2xl"
                >
